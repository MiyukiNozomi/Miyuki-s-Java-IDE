...
public class Warn {
	...
	public static void launchError(String msg, String dynamic) {
		...
		errorFrame.setIconImage(Toolkit.getDefaultToolkit().getImage(Warn.class.getResource("/com/miyukideveloper/ide/images/ide_icon.png")));
		errorFrame.setSize(new Dimension(500, 200));
		errorFrame.setResizable(false);
		errorFrame.setLocationRelativeTo(null);
		
		ImageIcon icon = new ImageIcon(Warn.class.getResource("/com/miyukideveloper/ide/images/sun/dialog-error@2x.png"));
	...
	public static void launchWarn(String msg, String dynamic) {
		...
		warnFrame.setIconImage(Toolkit.getDefaultToolkit().getImage(Warn.class.getResource("/com/miyukideveloper/ide/images/ide_icon.png")));
		warnFrame.setSize(new Dimension(500, 200));
		warnFrame.setLocationRelativeTo(null);
		warnFrame.setResizable(false);
		
		ImageIcon icon = new ImageIcon(Warn.class.getResource("/com/miyukideveloper/ide/images/sun/dialog-warning@2x.png"));
		Image temp = icon.getImage().getScaledInstance(80,80, 0);
		icon = new ImageIcon(temp);
